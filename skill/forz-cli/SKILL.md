...
description: >-
  ...
  forz.io, field-service jobs/dispatch, or an `fz_live_`/`fz_test_` API key. It covers
...
management — customers, jobs, invoices, etc.). This skill captures the conventions that
